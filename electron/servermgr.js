...
module.exports.startServer = function() {
    if (serverProcess === null) {
        ...
        console.info(tagMgr + 'Command: ' + serverExecLocation +
        ...
        serverProcess.stderr.on('data', function(data) {
            console.error(tagSrv + data);
        });

        serverProcess.on('close', function(code) {
            if (code !== 0) {
                console.info(tagSrv + 'Process exited with code ' + code);
            }
            serverProcess = null;
        });
    }    
...
module.exports.stopServer = function() {
    if (serverProcess !== null) {
        ...
        serverProcess = null;
        console.info(tagMgr + 'Server stopped.');
    }
};

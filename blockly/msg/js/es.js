...
Blockly.Msg.ARD_TYPE_SHORT = "Numero corto";
Blockly.Msg.ARD_TYPE_NUMBER = "Numero";
Blockly.Msg.ARD_TYPE_LONG = "Numero largo";
...
Blockly.Msg.ARD_HIGHLOW_TIP = "Asigna el estado de un pin logico a High o Low.";
Blockly.Msg.ARD_DIGITALREAD = "leer pin digital #";
Blockly.Msg.ARD_DIGITALREAD_TIP = "Lee el valor digital de un pin: HIGH o LOW";
Blockly.Msg.ARD_DIGITALWRITE = "asignar pin digital #";
Blockly.Msg.ARD_WRITE_TO = "a";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Escribe un valor digital HIGH o LOW a un puerto especifico";
Blockly.Msg.ARD_BUILTIN_LED = "asignar built-in LED";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Enciender o apagar un built-in LED del Arduino";
Blockly.Msg.ARD_DEFINE = "Definir";
Blockly.Msg.ARD_TONE_PIN = "Tono en PIN#";
Blockly.Msg.ARD_TONE_FREQ = "frecuencia";
Blockly.Msg.ARD_TONE_PIN_TIP = "Generar tonos de audio en un pin";
Blockly.Msg.ARD_NOTONE_PIN = "Sin tono en PIN#";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Detiene la generacion de un tono en un pin";
Blockly.Msg.ARD_MAP = "Mapear";
Blockly.Msg.ARD_MAP_VAL = "valor de [0-";
Blockly.Msg.ARD_MAP_TIP = "Re-mapea un numero desde [0-1024] a otro.";
Blockly.Msg.ARD_FUN_RUN_SETUP = "Arduino ejecutar primero:";
Blockly.Msg.ARD_FUN_RUN_LOOP = "Arduino ciclo infinito:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Define las funciones de configuracion [setup()] y ciclo [loop()] de Arduino.";
Blockly.Msg.ARD_PIN_WARN1 = "Pin %1 es necesario para %2 como pin %3. Ya en uso como %4.";
Blockly.Msg.ARD_SERIAL_SETUP = "Configurar";
Blockly.Msg.ARD_SERIAL_SPEED = ":  velocidad a";
Blockly.Msg.ARD_SERIAL_BPS = "bps";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Selecciona la velocidad para un perisferico serial especifico";
Blockly.Msg.ARD_SERIAL_PRINT = "imprimir";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "agregar un salto de linea";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "Imprime datos a la consola o puerto serie utilizando texto ASCII.";
Blockly.Msg.ARD_SERIAL_AVAILABLE = "disponible para leer";
Blockly.Msg.ARD_SERIAL_AVAILABLE_TIP = "Devuelve verdadero si el numero de bytes disponibles para leer es mayor que cero.";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "Un bloque de configuracion para %1 debe ser agregado al espacio de trabajo para utilizar este bloque!";
Blockly.Msg.ARD_SERIAL_READ = "Leer";
Blockly.Msg.ARD_SERIAL_READ_TIP = "Lee un caracter de un puerto serie";
Blockly.Msg.ARD_SERVO_WRITE = "asignar SERVO desde el Pin";
Blockly.Msg.ARD_SERVO_WRITE_TO = "a";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "Grados (0~180)";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Asigna un Servo a un angulo especifico";
Blockly.Msg.ARD_SERVO_READ = "leer SERVO desde PIN#";
Blockly.Msg.ARD_SERVO_READ_TIP = "Leer un angulo del Servo";
Blockly.Msg.ARD_SPI_SETUP = "Configurar";
Blockly.Msg.ARD_SPI_SETUP_CONF = "definir parametros:";
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "cambio de datos";
Blockly.Msg.ARD_SPI_SETUP_MSBFIRST = "MSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "reloj divisor";
Blockly.Msg.ARD_SPI_SETUP_MODE = "modo SPI (inactivo - limite)";
Blockly.Msg.ARD_SPI_SETUP_MODE0 = "0 (Low - Descendente)";
Blockly.Msg.ARD_SPI_SETUP_MODE1 = "1 (Low - Ascendente)";
Blockly.Msg.ARD_SPI_SETUP_MODE2 = "2 (High - Descendente)";
Blockly.Msg.ARD_SPI_SETUP_MODE3 = "3 (High - Ascendente)";
Blockly.Msg.ARD_SPI_SETUP_TIP = "Configura el periferico SPI.";
Blockly.Msg.ARD_SPI_TRANS_NONE = "ninguno";
Blockly.Msg.ARD_SPI_TRANS_VAL = "transferir";
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "a pin esclavo";
Blockly.Msg.ARD_SPI_TRANS_TIP = "Envia un mensaje SPI a un dispositivo esclavo especifico.";
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "Un bloque de configuracion para %1 debe ser agregado al area de trabajo para usar este bloque!";
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "El valor anterior %1 del pin ya no esta disponible.";
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "Envia un mensaje SPI a un dispositivo esclavo especifico y retorna los datos.";
Blockly.Msg.ARD_STEPPER_SETUP = "Configurar motor stepper";
Blockly.Msg.ARD_STEPPER_MOTOR = "parametros:";
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "MiStepper";
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "Numero de pines";
...
Blockly.Msg.ARD_STEPPER_REVOLVS = "cuantos pasos por revolucion";
Blockly.Msg.ARD_STEPPER_SPEED = "asignar velocidad (rpm) a";
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Configura los pines y otros seteos a un motor stepper";
Blockly.Msg.ARD_STEPPER_STEP = "mover stepper";
Blockly.Msg.ARD_STEPPER_STEPS = "pasos";
Blockly.Msg.ARD_STEPPER_STEP_TIP = "Cambia a un numero de pasos especificos para el motor stepper";
Blockly.Msg.ARD_STEPPER_COMPONENT = "stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP = "Configurar motor stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_MOTOR = "parametros:";
Blockly.Msg.ARD_MEGAPI_STEPPER_DEFAULT_NAME = "MiMegaPiStepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_SLOT = "slot#";
Blockly.Msg.ARD_MEGAPI_STEPPER_REVOLVS = "cuantos pasos por revolucion";
Blockly.Msg.ARD_MEGAPI_STEPPER_SPEED = "asignar velocidad (rpm) a";
Blockly.Msg.ARD_MEGAPI_STEPPER_ACCELERATION = "asignar aceleracion a";
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP_TIP = "Configura los pines y otros seteos a un motor stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP = "mover stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TO = "mover stepper MegaPi a ";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS_TO = "pasos";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS = "pasos";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN = "ejecutar MegaPi stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN_TIP = "ejecuta las instrucciones de MegaPi stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TIP = "Cambia a un numero de pasos especificos para el motor stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_COMPONENT = "stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_LINE_FOLLOWER_SETUP = "Configurar MegaPi seguidor de linea:";
Blockly.Msg.ARD_MEGAPI_LINE_FOLLOWER_DEFAULT_NAME = "MiMegaPiSeguidor";
Blockly.Msg.ARD_MEGAPI_LINE_FOLLOWER_PORT = "puerto#";
Blockly.Msg.ARD_MEGAPI_LINE_FOLLOWER_SETUP_TIP = "Configura el pin para un seguidor de linea MegaPi y otras configuraciones.";
Blockly.Msg.ARD_MEGAPI_LINE_FOLLOWER_READ_SENSOR = "Leer sensores de MegaPi seguidor de linea";
...
Blockly.Msg.ARD_MEGAPI_ULTRASONIC_PORT = "puerto #";
Blockly.Msg.ARD_MEGAPI_ULTRASONIC_SETUP_TIP = "Configura el pin para un sensor ultrasonico MegaPi y otras configuraciones.";
Blockly.Msg.ARD_MEGAPI_ULTRASONIC_DISTANCE = "Distancia en Cm sensor ultrasonico MegaPi";
Blockly.Msg.ARD_MEGAPI_ULTRASONIC_DISTANCE_TIP = "Lee la distancia a un obstaculo en cm para un sensor ultrasonico MegaPi";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_SETUP = "Configurar Motor DC MegaPi";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_DEFAULT_NAME = "MiMegaPiMotorDC";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_PORT = "puerto #";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_SPEED = "a velocidad (rpm)";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_SETUP_TIP = "Configura el puerto y otros seteos de un Motor DC MegaPi.";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_RUN = "ejecutar DC Motor MegaPi";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_RUN_TIP = "Ejecuta Motor DC MegaPi a la velocidad especificada";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_STOP = "detener Motor DC MegaPi";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_STOP_TIP = "Detiene el Motor DC MegaPi.";
Blockly.Msg.ARD_MEGAPI_DC_MOTOR_COMPONENT = "Motor DC MegaPi";
Blockly.Msg.ARD_MEGAPI_GYRO_SETUP = "Configurar Gyro MegaPi:";
Blockly.Msg.ARD_MEGAPI_GYRO_DEFAULT_NAME = "MiMegaPiGyro";
Blockly.Msg.ARD_MEGAPI_GYRO_SETUP_TIP = "Configura un sensor Gyro MegaPi.";
Blockly.Msg.ARD_MEGAPI_GYRO_READ_ANGLEX = "Leer angulo X de Gyro MegaPi";
Blockly.Msg.ARD_MEGAPI_GYRO_READ_ANGLEY = "Leer angulo Y de Gyro MegaPi";
Blockly.Msg.ARD_MEGAPI_GYRO_READ_ANGLEZ = "Leer angulo Z de Gyro MegaPi";
Blockly.Msg.ARD_MEGAPI_GYRO_READ_ANGLE_AXIS_TIP = "Lee el valor de los angulos de los ejes x/y/z para un dispositivo Gyro MegaPi";
Blockly.Msg.ARD_MEGAPI_ENCODER_INIT = "Iniciar Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_INIT_TIP = "Inicializa todas las configuraciones del Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETUP = "Configurar Motor MegaPi Encoder: ";
Blockly.Msg.ARD_MEGAPI_ENCODER_DEFAULT_NAME = "MiMegaPiEncoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_MOTOR = "MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SLOT = "Puerto #";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETUP_TIP = "Configura un Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETTARPWM = "Asignar PWM Tar de MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETTARPWM_TIP = "Asigna la funcion PWM Tar del Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETPULSE = "Asignar pulso de MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETPULSE_TIP = "Asigna el pulso del Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_COMPONENT = "Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETMOTORPWM = "Asignar PWM de MegaPi Encoder ";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETMOTORPWM_TIP = "Asigna el PWM de un Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETRATIO = "Asignar relación para MegaPi Encoder ";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETRATIO_TIP = "Asigna la relación para el Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETPOSPID = "Asignar Posicion PID de MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETPOSPID_P = "parametro P";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETPOSPID_I = "parametro I";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETPOSPID_D = "parametro D";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETPOSPID_TIP = "Asigna la posicion PID y sus parametross para el Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETSPEEDPID = "Asignar velocidad PID de MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETSPEEDPID_P = "parametro P";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETSPEEDPID_I = "parametro I";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETSPEEDPID_D = "parametro D";
Blockly.Msg.ARD_MEGAPI_ENCODER_SETSPEEDPID_TIP = "Asigna la velocidad PID y sus parametross para el Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_RUNSPEED = "Ejecutar MegaPi Encoder a velocidad ";
Blockly.Msg.ARD_MEGAPI_ENCODER_RUNSPEED_TIP = "Ejecuta el Motor MegaPi Encoder a la velocidad especificada";
Blockly.Msg.ARD_MEGAPI_ENCODER_MOVETO = "Mover MegaPi Encoder a";
Blockly.Msg.ARD_MEGAPI_ENCODER_MOVETO_POS = "Posicion";
Blockly.Msg.ARD_MEGAPI_ENCODER_MOVETO_SPEED = "Velocidad";
Blockly.Msg.ARD_MEGAPI_ENCODER_MOVETO_TIP = "Mueve a la posicion y velocidad establecida al Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_GETCURPOS = "Leer Posicion de MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_GETCURPOS_TIP = "Lee la posicion actual de Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_GETCURRENTSPEED = "Leer velocidad de MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_GETCURRENTSPEED_TIP = "Lee la velocidad actual de Motor MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_UPDATESPEED = "Actualizar velocidad de MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_UPDATESPEED_TIP = "Actualiza en el Motor MegaPi Encoder la velocidad asignada previamente";
Blockly.Msg.ARD_MEGAPI_ENCODER_GO_STRAIGHT = "Mover Motores MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_GO_STRAIGHT_SPEED = "velocidad";
Blockly.Msg.ARD_MEGAPI_ENCODER_FOR_BACK = "dirección";
Blockly.Msg.ARD_MEGAPI_ENCODER_GO_STRAIGHT_TIP = "Asigna la velocidad para avanzar o retroceder a los Motores MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_FORWARD = "adelante";
Blockly.Msg.ARD_MEGAPI_ENCODER_BACKWARD = "atrás";
Blockly.Msg.ARD_MEGAPI_ENCODER_LEFT = "izquierda";
Blockly.Msg.ARD_MEGAPI_ENCODER_RIGHT = "derecha";
Blockly.Msg.ARD_MEGAPI_ENCODER_SPIN = "Girar Motores MegaPi Encoder";
Blockly.Msg.ARD_MEGAPI_ENCODER_SPIN_TIME = "Girar durante (en milisegundos)";
Blockly.Msg.ARD_MEGAPI_ENCODER_SPIN_DIR = "dirección";
Blockly.Msg.ARD_MEGAPI_ENCODER_SPIN_TIP = "Asigna hacia donde girará los Motores MegaPi Encoder";
...
Blockly.Msg.ARD_MHZ19_SETUP = "Configurar Sensor MHZ19 CO2";
Blockly.Msg.ARD_MHZ19_DEFAULT_NAME = "MiMHZ19";
Blockly.Msg.ARD_MHZ19_RX_PORT = "Pin RX";
Blockly.Msg.ARD_MHZ19_TX_PORT = "Pin TX";
Blockly.Msg.ARD_MHZ19_SETUP_TIP = "Configura un Sensor MHZ19 de CO2";
Blockly.Msg.ARD_MHZ19_GETCO2 = "Leer CO2 en ppm de MHZ19";
Blockly.Msg.ARD_MHZ19_GETCO2_TIP = "Lee el valor de CO2 en ppm del Sensor MHZ19";
Blockly.Msg.ARD_MHZ19_GETTEMP = "Leer Temperatura en °C de MHZ19";
Blockly.Msg.ARD_MHZ19_GETTEMP_TIP = "Lee el valor de temperatura en °C del Sensor MHZ19";
Blockly.Msg.ARD_DHT11_SETUP = "Configurar Sensor DHT11 Temp/Humedad";
Blockly.Msg.ARD_DHT11_PIN = "Pin";
Blockly.Msg.ARD_DHT11_SETUP_TIP = "Configura un Sensor DHT11 de Temp y Humedad";
Blockly.Msg.ARD_DHT11_READHUMIDITY = "Leer Humedad de DHT11";
Blockly.Msg.ARD_DHT11_READHUMIDITY_TIP = "Lee la humedad relativa en el sensor DHT11";
Blockly.Msg.ARD_DHT11_READTEMP = "Leer Temperatura de DHT11 en °C";
Blockly.Msg.ARD_DHT11_READTEMP_TIP = "Lee el valor de temperatura en °C del Sensor DHT11";
Blockly.Msg.ARD_DHT11_COMPUTEHEAT = "Leer el indice de calor de DHT11";
Blockly.Msg.ARD_DHT11_COMPUTE_TEMP = "Temperatura";
Blockly.Msg.ARD_DHT11_COMPUTE_HUM = "Humedad";
Blockly.Msg.ARD_DHT11_DEFAULT_NAME = "MiDHT11";
Blockly.Msg.ARD_DHT11_COMPUTEHEAT_TIP = "Lee el indice de calor del sensor DHT11";
...
Blockly.Msg.ARD_TIME_DELAY_TIP = "Espera un numero especifico de milisegundos";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "microsegundos";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Espera un numero especifico de microsegundos";
Blockly.Msg.ARD_TIME_MILLIS = "tiempo actual transcurrido (milisegundos)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Devuelve el numero de milisegundos desde que la placa Arduino comenzó a ejecutar el programa actual. Ha sido almacenado en un numero del tipo entero largo positivo";
Blockly.Msg.ARD_TIME_MICROS = "tiempo actual transcurrido (microsegundos)";
Blockly.Msg.ARD_TIME_MICROS_TIP = "Devuelve el numero de microsegundos desde que la placa Arduino comenzó a ejecutar el programa actual. Ha sido almacenado en un numero del tipo entero largo positivo";
Blockly.Msg.ARD_TIME_INF = "esperar indefinidamente (finalizar el programa)";
Blockly.Msg.ARD_TIME_INF_TIP = "Espera indefinidamente, deteniendo el programa.";
Blockly.Msg.ARD_VAR_AS = "como";
Blockly.Msg.ARD_VAR_AS_TIP = "Asigna un valor a un tipo especifico";
Blockly.Msg.ARD_PULSE_READ = "medir pulso %1 en el pin #%2";
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "medir pulso %1 en el pin #%2 (terminar despues de %3 μs)";
Blockly.Msg.ARD_PULSE_TIP = "Mide la duracion de un pulso en el pin seleccionado.";
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Mide la duracion de un pulso en el pin seleccionado, despues de los microsegundos especificados.";
Blockly.Msg.ARD_SETTONE = "Asignar tono en el pin #";
Blockly.Msg.ARD_TONEFREQ = "a la frecuencia";
Blockly.Msg.ARD_TONE_TIP = "Asigna un tono en el pin con la frecuencia especificada en el rango 31 - 65535";
Blockly.Msg.ARD_TONE_WARNING = "Frecuencia debe estar en el rango 31 - 65535";
Blockly.Msg.ARD_NOTONE = "Apagar el tono en el pin #";
Blockly.Msg.ARD_NOTONE_TIP = "Apaga el tono en el pin seleccionado";
Blockly.Msg.NEW_INSTANCE = "Nueva instancia...";
Blockly.Msg.RENAME_INSTANCE = "Renombrar instancia...";
Blockly.Msg.NEW_INSTANCE_TITLE = "Nombre de la nueva instancia:";

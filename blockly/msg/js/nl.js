...
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP = "Definieer stappenmotor MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_MOTOR = "sappnmotor MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_DEFAULT_NAME = "MijnMegaPiStappenMotor";
Blockly.Msg.ARD_MEGAPI_STEPPER_SLOT = "slot#";
Blockly.Msg.ARD_MEGAPI_STEPPER_REVOLVS = "aantal stappen per omwenteling";
Blockly.Msg.ARD_MEGAPI_STEPPER_SPEED = "zet snelheid (rpm) op";
Blockly.Msg.ARD_MEGAPI_STEPPER_ACCELERATION = "versnelling instellen a";
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP_TIP = "Configureert een stappenmotor MegaPi, pinouts en andere waarden zoals rondes per minuut.";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP = "beweeg stappenmotor MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TO = "beweeg a stappenmotor MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS_TO = "stappen a";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS = "stappen";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN = "uitvoeren MegaPi stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN_TIP = "voer MegaPi Stepper-instructies uit";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TIP = "Draait de stappenmotor MegaPi een opgegeven aantal stappen";
Blockly.Msg.ARD_MEGAPI_STEPPER_COMPONENT = "stappenmotor MegaPi";

...
Blockly.Msg.ARD_ANALOGREAD_PULLUP = "Считать pull up аналоговый вход №";
...
Blockly.Msg.ARD_STEPPER_COMPONENT = "шаговый мотор MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP = "Конфигурация MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_MOTOR = "шагового мотора MegaPi:";
Blockly.Msg.ARD_MEGAPI_STEPPER_DEFAULT_NAME = "MyMegaPiStepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_SLOT = "пин №";
Blockly.Msg.ARD_MEGAPI_STEPPER_REVOLVS = "количество шагов за оборот";
Blockly.Msg.ARD_MEGAPI_STEPPER_SPEED = "скорость, оборот/с";
Blockly.Msg.ARD_MEGAPI_STEPPER_ACCELERATION = "ускорение";
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP_TIP = "Настраивает выходной пин шагового мотора и прочие свойства.";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP = "запустить шаговый MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TO = "запустить шаговый MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS_TO = "шаг(ов)";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS = "шаг(ов)";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN = "выполнять MegaPi stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN_TIP = "выполнять указания MegaPi stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TIP = "Поворачивает шаговый мотор MegaPi на указанное количество шагов.";
Blockly.Msg.ARD_MEGAPI_STEPPER_COMPONENT = "шаговый мотор MegaPi";

...
Blockly.Msg.ARD_ANALOGREAD_PULLUP = "leggi via pull up pin analogico #";
...
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP = "Imposta un motore stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_MOTOR = "motore stepper MegaPi:";
Blockly.Msg.ARD_MEGAPI_STEPPER_DEFAULT_NAME = "MyMegaPiStepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_SLOT = "slot#";
Blockly.Msg.ARD_MEGAPI_STEPPER_REVOLVS = "quanti passi per ogni rotazione";
Blockly.Msg.ARD_MEGAPI_STEPPER_SPEED = "imposta la velocità (rpm) a";
Blockly.Msg.ARD_MEGAPI_STEPPER_ACCELERATION = "imposta la accelerazione a";
Blockly.Msg.ARD_MEGAPI_STEPPER_SETUP_TIP = "Configura i pin e altre impostazioni di un motore stepper MegaPi.";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP = "muovi stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TO = "muovi a stepper MegaPi";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS_TO = "passi a";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEPS = "passi";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN = "eseguire MegaPi stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_RUN_TIP = "eseguire le istruzioni MegaPi Stepper";
Blockly.Msg.ARD_MEGAPI_STEPPER_STEP_TIP = "Fai girare di un certo numero di passi il motore stepper MegaPi.";
